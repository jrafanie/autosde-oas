...
# Unit tests for OpenapiClient::VolumeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VolumeResponse do
  let(:instance) { OpenapiClient::VolumeResponse.new }

  describe 'test an instance of VolumeResponse' do
    it 'should create an instance of VolumeResponse' do
      expect(instance).to be_instance_of(OpenapiClient::VolumeResponse)
    end
  end
