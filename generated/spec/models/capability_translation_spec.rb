...
# Unit tests for AutosdeOpenapiClient::CapabilityTranslation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AutosdeOpenapiClient::CapabilityTranslation do
  let(:instance) { AutosdeOpenapiClient::CapabilityTranslation.new }

  describe 'test an instance of CapabilityTranslation' do
    it 'should create an instance of CapabilityTranslation' do
      expect(instance).to be_instance_of(AutosdeOpenapiClient::CapabilityTranslation)
    end
  end
