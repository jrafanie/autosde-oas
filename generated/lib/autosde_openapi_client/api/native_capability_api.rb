...
module AutosdeOpenapiClient
  class NativeCapabilityApi
    ...
    def native_capabilities_get(opts = {})
      data, _status_code, _headers = native_capabilities_get_with_http_info(opts)
      data
    end

    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<NativeCapability>, Integer, Hash)>] Array<NativeCapability> data, response status code and response headers
    def native_capabilities_get_with_http_info(opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NativeCapabilityApi#native_capabilities_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def native_capabilities_pk_delete_with_http_info(pk, opts = {})
      ...
      if @api_client.config.client_side_validation && pk.nil?
        fail ArgumentError, "Missing the required parameter 'pk' when calling NativeCapabilityApi.native_capabilities_pk_delete"
      end
      # resource path
      local_var_path = '/native-capabilities/{pk}'.sub('{' + 'pk' + '}', CGI.escape(pk.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NativeCapabilityApi#native_capabilities_pk_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def native_capabilities_pk_get_with_http_info(pk, opts = {})
      ...
      # verify the required parameter 'pk' is set
      if @api_client.config.client_side_validation && pk.nil?
        fail ArgumentError, "Missing the required parameter 'pk' when calling NativeCapabilityApi.native_capabilities_pk_get"
      end
      # resource path
      local_var_path = '/native-capabilities/{pk}'.sub('{' + 'pk' + '}', CGI.escape(pk.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NativeCapabilityApi#native_capabilities_pk_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def native_capabilities_post_with_http_info(native_capability, opts = {})
      ...
      # verify the required parameter 'native_capability' is set
      if @api_client.config.client_side_validation && native_capability.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NativeCapabilityApi#native_capabilities_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
