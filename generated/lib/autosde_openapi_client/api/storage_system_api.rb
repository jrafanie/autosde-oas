...
module AutosdeOpenapiClient
  class StorageSystemApi
    ...
    def storage_systems_get(opts = {})
      data, _status_code, _headers = storage_systems_get_with_http_info(opts)
      data
    end

    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<StorageSystem>, Integer, Hash)>] Array<StorageSystem> data, response status code and response headers
    def storage_systems_get_with_http_info(opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageSystemApi#storage_systems_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def storage_systems_pk_delete_with_http_info(pk, opts = {})
      ...
      if @api_client.config.client_side_validation && pk.nil?
        fail ArgumentError, "Missing the required parameter 'pk' when calling StorageSystemApi.storage_systems_pk_delete"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageSystemApi#storage_systems_pk_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def storage_systems_pk_get_with_http_info(pk, opts = {})
      ...
      # verify the required parameter 'pk' is set
      if @api_client.config.client_side_validation && pk.nil?
        fail ArgumentError, "Missing the required parameter 'pk' when calling StorageSystemApi.storage_systems_pk_get"
      end
      # resource path
      local_var_path = '/storage-systems/{pk}'.sub('{' + 'pk' + '}', CGI.escape(pk.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageSystemApi#storage_systems_pk_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def storage_systems_post_with_http_info(storage_system_create, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageSystemApi#storage_systems_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
