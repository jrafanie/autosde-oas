...
# Unit tests for OpenapiClient::VolumeCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VolumeCreate do
  let(:instance) { OpenapiClient::VolumeCreate.new }

  describe 'test an instance of VolumeCreate' do
    it 'should create an instance of VolumeCreate' do
      expect(instance).to be_instance_of(OpenapiClient::VolumeCreate)
    end
  end
