...
module AutosdeOpenapiClient
  ...
  class Profile
    ...
    # Type values are 'Native' or 'Abstract'. doc-todo:I need to know that I got these values correct.
    attr_accessor :type
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["Native", "Abstract"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Native", "Abstract"])
    ...
    def hash
      [account, description, name, type, uuid].hash
    end
